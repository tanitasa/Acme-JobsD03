...
<acme:form readonly="true">
	...
	<acme:form-moment code="administrator.announcement.form.label.creationMoment" path="creationMoment"/>
	<acme:form-double code="administrator.announcement.form.label.link" path="link"/>
